...
using AppAuction.API.Repositories.DataAccess;
...
builder.Services.AddDbContext<AppAuctionDbContext>(options =>
{
    options.UseSqlite(@"Data Source=C:\dev\AuctionApi\leilaoDbNLW.db");
});
